...
/***/ function(module, exports, __webpack_require__) {
	...
	function startGame() {
		...
		game.state.add("Boot", __webpack_require__(2));
		game.state.add("Preloader", __webpack_require__(3));
		game.state.add("Lobby", __webpack_require__(4));
		game.state.add("StageSelect", __webpack_require__(9));
		game.state.add("PendingGame", __webpack_require__(5));
		game.state.add("Level", __webpack_require__(6));
		game.state.add("GameOver", __webpack_require__(7));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PowerupIDs = __webpack_require__(11);
